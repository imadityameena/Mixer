    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl lg:text-5xl font-bold text-teal-600 mb-8 leading-tight">
          ...
          <p className="text-lg text-gray-700 leading-relaxed mb-12 max-w-3xl mx-auto">
            ...
            and wasted time. At Mixer, we do things differently. We'll match you
            with the right person and curate the perfect date—no apps, no
      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <button className="bg-teal-600 hover:bg-teal-700 text-white font-medium py-4 px-8 rounded-full transition-colors duration-200 text-lg">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      ...
                      chat with one of our Mixologists about your expectations.
                      From there, you decide—keep it classic with a table for
                      two, or triple your chances with a lively table for six.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      ...
                      arrival, your Mixologist will greet you and introduce you
                      to your party. Then it's your turn to relax, have fun, and
                      enjoy the night!
                    </p>
                  </div>
                </div>
